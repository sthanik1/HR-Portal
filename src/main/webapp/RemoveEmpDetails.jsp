...
<%	
 ...
 %> 
  ...
  <div class="container-fluid title">
    ...
    <div class="col-lg-6">
      <h1 align="center">Delete Entry!!</h1>
    </div>
  </div>
...
%>
<form class="FillForm" action="RemoveEmpDetails.jsp" method="GET">
<table class="table table-bordered table-striped">
	...
	<tr><td><input type="submit" name="" value="Remove" ></td></tr>
</table>
</form>
	...
	t.deleteParticularEmp(fName,eId);
 }}
	%>
