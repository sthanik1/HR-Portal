...
%>
<form class="FillForm" action="UpdateEmpDetails.jsp" method="GET">
<table class="table table-bordered table-striped">
    ...
    <tr><td><input type="submit" name="search" value="Update" ></td></tr>
</table>
</form>
	...
	t.updateEmployeeDetails(eId,fName,lName,pNo,sal,email);
    }
 }
    }
	%>
